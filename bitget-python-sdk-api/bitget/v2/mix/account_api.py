...
class AccountApi(Client):
    ...
    def setLeverage(self, params):
        return self._request_with_params(
            POST, "/api/v2/mix/account/set-leverage", params
        )
    ...
    def setMarginMode(self, params):
        return self._request_with_params(
            POST, "/api/v2/mix/account/set-margin-mode", params
        )

    def setPositionMode(self, params):
        return self._request_with_params(
            POST, "/api/v2/mix/account/set-position-mode", params
        )
    ...
    def singlePosition(self, params):
        return self._request_with_params(
            GET, "/api/v2/mix/position/single-position", params
        )
