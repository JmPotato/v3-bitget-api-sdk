...
class AccountApi(Client):
    ...
    def setLeverage(self, params):
        return self._request_with_params(
            POST, "/api/mix/v1/account/setLeverage", params
        )
    ...
    def setMarginMode(self, params):
        return self._request_with_params(
            POST, "/api/mix/v1/account/setMarginMode", params
        )

    def setPositionMode(self, params):
        return self._request_with_params(
            POST, "/api/mix/v1/account/setPositionMode", params
        )

    def singlePosition(self, params):
        return self._request_with_params(
            GET, "/api/mix/v1/position/singlePosition", params
        )

    def allPosition(self, params):
        return self._request_with_params(
            GET, "/api/mix/v1/position/allPosition", params
        )
