...
class OrderApi(Client):
    ...
    def batchOrders(self, params):
        return self._request_with_params(
            POST, "/api/spot/v1/trade/batch-orders", params
        )

    def cancelOrder(self, params):
        return self._request_with_params(
            POST, "/api/spot/v1/trade/cancel-order", params
        )

    def batchCancelOrder(self, params):
        return self._request_with_params(
            POST, "/api/spot/v1/trade/cancel-batch-orders", params
        )
    ...
    def traderOrderCloseTracking(self, params):
        return self._request_with_params(
            POST, "/api/spot/v1/trace/order/closeTrackingOrder", params
        )

    def traderOrderCurrentTrack(self, params):
        return self._request_with_params(
            POST, "/api/spot/v1/trace/order/orderCurrentList", params
        )

    def traderOrderHistoryTrack(self, params):
        return self._request_with_params(
            GET, "/api/spot/v1/trace/order/orderHistoryList", params
        )
